...
import static com.service.user.constants.MessageConstants.MSG_RESPONSE_COMMON_FAIL;
import static com.service.user.constants.MessageConstants.MSG_RESPONSE_SUCCESS;
...
public class UserAuthServiceImpl implements UserAuthService {
    ...
    public ResponseEntity<ResponseUserAuthVo> login(RequestUserAuthVo requestUserAuthVo) {
        ...
        try {
            responseUserAuthVo.setResponseCode(HttpStatus.OK.value());
    ...
    public ResponseEntity<ResponseUserAuthVo> registerUser(RequestUserAuthVo requestUserAuthVo) {
        ...
        try {
            ...
            responseUserAuthVo.setResponseCode(HttpStatus.INTERNAL_SERVER_ERROR.value());
    ...
    public ResponseEntity<CmnResponseVo> logout(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            return ResponseEntity.ok(new CmnResponseVo(HttpStatus.OK.value(), MSG_RESPONSE_SUCCESS));
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(new CmnResponseVo(HttpStatus.INTERNAL_SERVER_ERROR.value(), MSG_RESPONSE_COMMON_FAIL));
        }
    }
